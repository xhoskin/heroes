//(function(){ 
  ...
  //класс существа
  function Creature( name, level, damageMin, damageMax, attack, defense, health, speed, growth, price ) {
    //properties
    this.name      = name,
    this.level     = level,
  ...
  City.prototype.addCreature = function( name, level, damageMin, damageMax, attack, defense, health, speed, growth, price ){
    this.list.push( new Creature( name, level, damageMin, damageMax, attack, defense, health, speed, growth, price ) );
  }
  ...
  //                 name,                  level, damageMin, damageMax, attack, defense, health, speed, growth, price
